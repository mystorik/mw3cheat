/* 
  wroten by the mofos at https://github.com/mysql/mysql-server/blob/8.0/include/mysql.h
  i just made it compatible with the mysql client library and made it work with the mysql_query functio
  made for cod-mwcheat
 */

 //Tweaked mysql client library to work with cod-mwcheat
